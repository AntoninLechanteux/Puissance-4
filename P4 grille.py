...
def placer_jeton(event):
    ...
    def animer_jeton(i):        
        ...
        if i <milieu_y:
            root.after(20, lambda: canva_jeu.delete(jeton))  # supprime l'ancien cercle
            root.after(20, lambda: animer_jeton(i + HEIGHT // ligne ))  # récursivité qui descend jusqu'à atteindre la limite²
